<template>
    <div>
        ...
        <div class="bg-yellow-100 border-b-2 border-yellow-300 font-serif">
            <div class="container py-12">
                <div class="lg:w-3/4 mx-auto">
                    <h3 class="text-center font-old text-6xl mb-6">Rules</h3>
                    <div class="flex flex-wrap -mx-4">
                        <div class="px-4 mb-6 w-full lg:w-1/2">
                            <h3 class="text-xl underline mb-4">Start of the game</h3>
                            <p class="mb-4">
                                You can play this game with 5-10 Players.
                                At the beginning of the game, each player gets assigned one of 3 Roles: <strong>Liberal</strong>, <strong>Fascist</strong> or <strong>Hitler</strong>.
                            </p>
                            <p class="mb-4">
                                Liberals have the majority, but they don't know anybodys role yet. The Facists know secret Hitler and each other and must work in secret and try to elect Hitler with any means necessary.
                            </p>
                            <table>
                                <tr>
                                    <th># Players</th>
                        ...
                        <div class="px-4 mb-6 w-full lg:w-1/2">
                            <h3 class="text-xl underline mb-4">How to win the game</h3>
                            <p class="mb-4">
                                In order to win, the <strong>Liberals</strong> need to enact 6 liberal Policies or kill Hitler.<br>
                                The <strong>Fascists</strong> need to enact only 5 fascist Policies to win the game or they can try to elect as Chancellor Hitler after already having enacted at least 3 of their Policies.
                            </p>
                        </div>
                    </div> 
                </div>
